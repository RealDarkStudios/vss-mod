...
import us.randos.very_serious_steven.config.VerySeriousConfig;
...
public class VerySeriousStevenFabric implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        // Config
        MidnightConfig.init(VerySeriousStevenConstants.VERY_SERIOUS_MOD_ID_FOR_THE_COOLEST_MOD_IN_EXISTENCE_NAMED_VERY_SERIOUS_STEVEN_MOD_FOR_THE_KAUPENHUB_SERVER, VerySeriousConfig.class);
    }
}
